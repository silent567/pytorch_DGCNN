...
parser = argparse.ArgumentParser(description='Generate Random Dataset by adding random pos noises to random classical graph patterns')
parser.add_argument('--size', metavar='S', type=int, default=100000, help='how many graphs are generated')
args = parser.parse_args()
print(args)

S = args.size
gens = [generate_random_classical_graph_with_pos_noise() for _ in range(S)]
